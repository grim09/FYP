 ...
 * @since 1.12
 */
public class ClientRequestInitializer extends CommonGoogleJsonClientRequestInitializer {
  ...
  public final void initializeJsonRequest(AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeRequest((ClientRequest<?>) request);
  }
   ...
   */
  protected void initializeRequest(ClientRequest<?> request) throws java.io.IOException {
  }
}
