...
public class Map2 extends Activity implements OnMenuItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myMap.moveCamera(CameraUpdateFactory.newLatLng(new LatLng(54.011188,-2.782167)));

		//loadRoute();
		RouteLoader rl = new RouteLoader();

		
		List<LatLng> latLongList = rl.loadRoute();
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		case R.id.action_camera:
			...
			startActivity(new Intent(Map2.this, ImageCapture.class));
			return true;
	...
	public boolean onMenuItemClick(MenuItem item) {
		...
		case R.id.route_two:
			...
			startActivity(new Intent(Map2.this, Map3.class));
			return true;
		case R.id.route_three:
			editor.putInt("route_setting", 3).commit();
			startActivity(new Intent(Map2.this, Map4.class));
			return true;
		case R.id.route_all:
			editor.putInt("route_setting", 0).commit();
			startActivity(new Intent(Map2.this, Map.class));
			return true;
		}
		return false;
	}
